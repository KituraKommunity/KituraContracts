...
/**
 Class defining shared resources for the [QueryDecoder](https://github.com/KituraKommunity/KituraContracts/blob/master/Sources/KituraContracts/CodableQuery/QueryDecoder.swift) and [QueryEncoder](https://github.com/KituraKommunity/KituraContracts/blob/master/Sources/KituraContracts/CodableQuery/QueryEncoder.swift).
